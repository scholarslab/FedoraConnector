...
<div class="field">
    ...
    <label for="csv-import-enable-virgo-import">Enable custom import functionality from Virgo?</label>
    <input type="checkbox" name="csv-import-enable-virgo-import" id="csv-import-enable-virgo-import" value="1" checked="checked">

    <p class="explanation">Check this box to enable a special workflow designed to make it easy to import .csv files generated by Virgo
