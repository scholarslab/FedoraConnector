...
class FedoraConnector_Importers
{

    //{{{ properties

    /**
     * This is the direcctory containing the importer plugins.
     *
     * @var string
     */
    var $importerDir;
    ...
    /**
     * This is the plugin manager for the importers.
     *
    ...
    /**
     * This initializes an instance of FedoraConnector_Importers.
     *
    ...
    /**
     * This returns the importer for a datastream's metadata.
     *
    ...
    /**
     * This importers the metadata from a datastream.
     *
     * @param Omeka_Record $datastream The datastream record.
     *
