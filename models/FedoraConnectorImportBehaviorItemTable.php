...
/**
 * Table class for the item-specific import behavior settings records.
 */
class FedoraConnectorImportBehaviorItemTable extends Omeka_Db_Table
{
     ...
     * exists.
     */
    public function getBehavior($field, $item)
    {
        ...
        $record = $this->fetchObject(
            $this->getSelect()->where('element_id = ' . $dcElement->id . ' AND item_id = ' . $item->id)
        );
