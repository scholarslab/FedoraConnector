...
require_once (__DIR__ . '/../../fedora_utils.php');

class FedoraConnector_Utils_Test extends PHPUnit_Framework_TestCase
{

    public function test_fedora_connector_installed() {
